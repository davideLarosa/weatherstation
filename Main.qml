 ...
 //   }
    Connections {
        ...
        function onDataChanged() {
            ...
            weather0.condition = appBridge.JsonData.current_condition[0].weatherDesc[0].value;
            ...
            weather1.rainMm = "Rain: " + appBridge.JsonData.weather[1].hourly[weather1.getHourIndex()].precipMM;
            ...
            weather2.rainMm = "Rain: " + appBridge.JsonData.weather[2].hourly[weather2.getHourIndex()].precipMM;
